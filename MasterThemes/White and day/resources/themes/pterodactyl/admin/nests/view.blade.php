        ...
        <div class="col-xs-6">
            <div class="box">
                ...
                <div class="box-footer">
                    ...
                    <button id="deleteButton" type="submit" name="_method" value="DELETE" class="btn btn-sm btn-danger muted muted-hover"><i class="fa fa-trash"></i></button>
                </div>
            </div>
        </div>
    <div class="col-xs-6">
                ...
                <table class="table table-hover">
                    ...
                    @foreach($nest->eggs as $egg)
                        <tr>
                            ...
                            <td class="align-middle">{!! $egg->description !!}</td>
