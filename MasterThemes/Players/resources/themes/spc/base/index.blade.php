                ...
                <table class="table table-hover">
                    <tbody>
                        <tr>
                            ...
                            <th class="text-center hidden-sm hidden-xs">Players</th>
                        ...
                        @foreach($servers as $server)
                            <tr class="dynamic-update ply-update" data-server="{{ $server->uuidShort }}">
                                ...
                                <td class="text-center hidden-sm hidden-xs"><span data-action="players">--</span> / <span data-action="maxplayers">--</span></td>
