...
<html>
    ...
    <body class="hold-transition skin-blue fixed sidebar-mini">
                ...
                <section class="sidebar">
                    @if (isset($server->name) && isset($node->name))
                        <div class="user-panel">
                            <div class="info ply-update" data-server="{{ $server->uuidShort }}">
                              <p>{{ $server->name }}</p>
                              <a href="#" id="server_status_icon"><i class="fa fa-circle text-default"></i> Checking...</a>
                              <a href="#"><i class="fa fa-users text-default"></i><span data-action="players">--</span> / <span data-action="maxplayers">--</span>
                            </div>
                        </div>
                    @endif
                    ...
                    @if($server->nest_id === 4 || $server->nest_id === 2)
                                <li
                                    @if(starts_with(Route::currentRouteName(), 'server.playerlist'))
                                        class="active"
                                    @endif
                                >
                                    <a href="{{ route('server.playerlist', $server->uuidShort) }}">
                                        <i class="fa fa-list-alt"></i> <span>Player List</span>
                                    </a>
                                </li>
					@endif
        ...
        @section('footer-scripts')
            ...
            {!! Theme::js('js/frontend/plist.js?t={cache-version}') !!}
