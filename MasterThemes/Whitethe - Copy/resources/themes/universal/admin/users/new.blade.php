        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="name_first" class="control-label">Users First Name</label>
                        <div>
                            <input type="text" autocomplete="off" name="name_first" value="{{ old('name_first') }}" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name_last" class="control-label">Users Last Name</label>
                        <div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>Language settings to control the users world!Mauhahahahh.....</small></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body">
                    <div class="form-group col-md-12">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>WARNING DO NOT TICK: Setting this to 'Yes' gives a user full administrative access. </small></p>
                        </div>
                    </div>
                </div>
            </div>
