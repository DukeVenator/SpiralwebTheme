            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="node_id" id="pNodeId" class="form-control" style="width: 100%">
        ...
        <div class="col-sm-6">
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    ...
                    <button name="_method" value="DELETE" class="btn btn-sm btn-danger pull-left muted muted-hover"><i class="fa fa-trash"></i></button>
                </div>
            </div>
        </div>
    </div>
