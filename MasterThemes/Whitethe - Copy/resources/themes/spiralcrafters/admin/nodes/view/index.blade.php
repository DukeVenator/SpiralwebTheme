...
<div class="row">
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating bg-gray">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            <tr>
                                ...
                                <td><code data-attr="info-version"><i class="fa fa-sync fa-fw fa-spin"></i></code> (Latest: <code>{{ $version->getDaemon() }}</code>)</td>
                            </tr>
                            <tr>
                                <td>System Information</td>
                                <td data-attr="info-system"><i class="fa fa-sync fa-fw fa-spin"></i></td>
                            </tr>
                            <tr>
                                <td>Total CPU Cores</td>
                                <td data-attr="info-cpus"><i class="fa fa-sync fa-fw fa-spin"></i></td>
                            </tr>
                        </table>
                    </div>
                </div>
