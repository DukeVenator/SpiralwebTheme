...
return [
    ...
    'node' => [
        'servers_attached' => 'A node must have no realms linked to it in order to be deleted.',
    ...
    'allocations' => [
        'server_using' => 'A realm is currently assigned to this allocation. An allocation can only be deleted if no realm is currently assigned.',
    ...
    'nest' => [
        'delete_has_servers' => 'A Nest with active realms attached to it cannot be deleted from the Panel.',
        'egg' => [
            'delete_has_servers' => 'An Egg with active realms attached to it cannot be deleted from the Panel.',
    ...
    'packs' => [
        'delete_has_servers' => 'Cannot delete a pack that is attached to active realms.',
        'update_has_servers' => 'Cannot modify the associated option ID when realms are currently attached to a pack.',
        ...
        'zip_extraction' => 'An exception was encountered while attempting to extract the archive provided onto the realm.',
    ...
    'subusers' => [
        ...
        'subuser_exists' => 'A user with that email address is already assigned as a subuser for this realm.',
    ],
    'databases' => [
    ...
    'api' => [
        'resource_not_found' => 'The requested resource does not exist on this realm.',
    ],
];
