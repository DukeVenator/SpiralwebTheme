...
return [
    'index' => [
        'title' => 'Viewing realm :name',
        'header' => 'realm Console',
        'header_sub' => 'Control your realm in real time.',
    ],
    'schedule' => [
        'header' => 'Schedule Manager',
        'header_sub' => 'Manage all of this realm\'s schedules in one place.',
        'current' => 'Current Schedules',
        'new' => [
            'header' => 'Create New Schedule',
            'header_sub' => 'Create a new set of scheduled tasks for this realm.',
        ...
        'schedule_created' => 'Successfully created a new schedule for this realm.',
    ...
    'tasks' => [
        ...
        'header_sub' => 'Automate your realm with minions.',
        ...
        'new' => [
            'header' => 'New Task',
            'header_sub' => 'Create a new scheduled task for the minions on this realm.',
            'task_name' => 'Task Name',
            'day_of_week' => 'Day of Week',
            'custom' => 'Custom Value',
            'day_of_month' => 'Day of Month',
    ...
    'users' => [
        'header' => 'Manage Mortals',
        'header_sub' => 'Control who can access your realm.',
        'configure' => 'Configure Permissions',
        'list' => 'Accounts with Access',
        'add' => 'Add New Subuser',
        'update' => 'Update Subuser',
        'user_assigned' => 'Successfully assigned a new subuser to this realm.',
        'user_updated' => 'Successfully updated permissions.',
        'edit' => [
            'header' => 'Edit Subuser',
            'header_sub' => 'Modify user\'s access to realm.',
        ],
        'new' => [
            'header' => 'Add New User',
            'header_sub' => 'Add a new user with permissions to this realm.',
            'email' => 'Email Address',
            'email_help' => 'Enter the email address for the mortal you wish to invite to manage this realm.',
            'power_header' => 'Power Management',
            'file_header' => 'File Management',
            'subuser_header' => 'Subuser Management',
            'server_header' => 'Realm Management',
            'task_header' => 'Schedule Management',
            'database_header' => 'Database Management',
            'power_start' => [
                'title' => 'Start Realm',
                'description' => 'Allows user to start the realm.',
            ],
            'power_stop' => [
                'title' => 'Stop Realm',
                'description' => 'Allows user to stop the realm.',
            ],
            'power_restart' => [
                'title' => 'Restart Server',
                'description' => 'Allows user to restart the realm.',
            ],
            'power_kill' => [
                'title' => 'Kill Server',
                'description' => 'Allows the mortal to kill the Realm\'s magic source.',
            ],
            'send_command' => [
            ...
            'access_sftp' => [
                'title' => 'SFTP Allowed',
                'description' => 'Allows user to connect to the SFTP magical portal provided by the demon that lurks.',
            ],
            'list_files' => [
                'title' => 'List Files',
                'description' => 'Allows user to list all files and folders on the realm but not view file contents.',
            ],
            'edit_files' => [
                'title' => 'Edit Files',
            ...
            'list_subusers' => [
                'title' => 'List Subusers',
                'description' => 'Allows user to view a listing of all subusers assigned to the realm.',
            ],
            'view_subuser' => [
                'title' => 'View Subuser',
            ...
            'create_subuser' => [
                ...
                'description' => 'Allows user to create additional subusers on the realm.',
            ],
            'delete_subuser' => [
                'title' => 'Delete Subuser',
                'description' => 'Allows a user to delete other subusers on the realm.',
            ],
            'view_allocations' => [
                'title' => 'View Allocations',
                'description' => 'Allows user to view all of the IPs and ports assigned to a realm.',
            ],
            'edit_allocation' => [
                'title' => 'Edit Default Connection',
                'description' => 'Allows user to change the default connection allocation to use for a realm.',
            ],
            'view_startup' => [
                'title' => 'View Startup Command',
                'description' => 'Allows user to view the startup command and associated variables for a realm.',
            ],
            'edit_startup' => [
                'title' => 'Edit Startup Command',
                'description' => 'Allows a user to modify startup variables for a realm.',
            ],
            'list_schedules' => [
                'title' => 'List Schedules',
                'description' => 'Allows a user to list all schedules (enabled and disabled)  for this realm.',
            ],
            'view_schedule' => [
                'title' => 'View Schedule',
            ...
            'delete_schedule' => [
                ...
                'description' => 'Allows a user to delete a schedule from the realm.',
            ],
            'view_databases' => [
                'title' => 'View Database Details',
                'description' => 'Allows user to view all databases associated with this realm including the usernames and passwords for the databases.',
            ],
            'reset_db_password' => [
            ...
            'delete_database' => [
                ...
                'description' => 'Allows a user to delete databases for this realm from the Panel.',
            ],
            'create_database' => [
                'title' => 'Create Database',
                'description' => 'Allows a user to create additional databases for this realm.',
            ],
        ],
    ],
    'allocations' => [
    ...
    'files' => [
        ...
        'path' => 'When configuring any file paths in your realm plugins or settings you should use :path as your base path. The maximum size for web-based file uploads to this node is :size.',
        ...
        'add' => [
            'header' => 'New File',
            'header_sub' => 'Create a new file on your realm.',
            'name' => 'File Name',
            'create' => 'Create File',
        ],
    ],
    'config' => [
        'name' => [
            'header' => 'Realm Name',
            'header_sub' => 'Change this realm\'s name.',
            'details' => 'The server name is only a reference to this realm on the panel, and will not affect any realm specific configurations that may display to users in games.',
        ],
        'startup' => [
            'header' => 'Start Configuration',
            'header_sub' => 'Control realm startup arguments.',
            'command' => 'Startup Command',
            'edit_params' => 'Edit Parameters',
            'update' => 'Update Startup Parameters',
            'startup_regex' => 'Input Rules',
            'edited' => 'Startup variables have been successfully edited. They will take effect the next time this realm is started.',
        ],
        'sftp' => [
        ...
        'database' => [
            'header' => 'Databases',
            'header_sub' => 'All databases available for this realm.',
            'your_dbs' => 'Configured Databases',
            'host' => 'MySQL Host',
            'reset_password' => 'Reset Password',
            'no_dbs' => 'There are no databases listed for this realm.',
            'add_db' => 'Add a new database.',
        ],
        'allocation' => [
            'header' => 'Server Allocations',
            'header_sub' => 'Control the IPs and ports available on this realm.',
