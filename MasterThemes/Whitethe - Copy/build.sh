...
if [ ! -f "artisan" ]; then
    ...
    cp -r MasterThemes/Whitethe/public ..
    cp -r MasterThemes/Whitethe/resources ..
    cp -r MasterThemes/Whitethe/database ..
    cp -r MasterThemes/Whitethe/config ..
    cp -r MasterThemes/Whitethe/app ..
